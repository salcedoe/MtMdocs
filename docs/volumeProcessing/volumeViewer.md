...
- **CT Lung Preset**
    ...
    Notice the alphamap here is semi-opaque (15%) for only a small subset of voxel intensities (ranging from -600 to -400). Remember, air intensities range around -1000 HUs.
